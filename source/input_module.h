...
enum target_names {theta_s, Omega_dcdmdr, omega_dcdmdr, Omega_scf, Omega_ini_dcdm, omega_ini_dcdm, Omega_dncdmdr, omega_dncdmdr, deg_ncdm_decay_dr, Omega_ini_dncdm, Neff_ini_dncdm, omega_ini_dncdm};
