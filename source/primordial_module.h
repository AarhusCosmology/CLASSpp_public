...
class PrimordialModule : public BaseModule {
 public:
  ...
  std::vector<int>
      ic_ic_size_; /**< number of ordered pairs of (index_ic1, index_ic2); this number is just N(N+1)/2  where N = ic_size[index_md] */
  std::vector<std::vector<short>>
      is_non_zero_; /**< is_non_zero[index_md][index_ic1_ic2] set to false if pair
 ...
 private:
  ...
  std::vector<std::vector<double>>
      lnpk_; /**< depends on indices index_md, index_ic1, index_ic2, index_k as:
                   ...
                   */
  std::vector<std::vector<double>>
      ddlnpk_; /**< second derivative of above array, for spline interpolation. So:
  ...
  std::vector<std::vector<double>>
      amplitude_; /**< all amplitudes in matrix form: amplitude[index_md][index_ic1_ic2] */
  std::vector<std::vector<double>>
      tilt_; /**< all tilts in matrix form: tilt[index_md][index_ic1_ic2] */
  std::vector<std::vector<double>>
      running_; /**< all runnings in matrix form: running[index_md][index_ic1_ic2] */
  //@}
