...
void DNCDM_DecayRadiationSpecies::ComputeBackground(double /*a_rel*/, const double* pvecback_B,
                                                    double* pvecback) {
  pvecback[index_bg_rho_] = pvecback_B[index_bi_rho_];
}

void DNCDM_DecayRadiationSpecies::BackgroundDerivs(double /*tau*/, const double* y, double* dy,
...
void DNCDM_DecayRadiationSpecies::RegisterPerturbationIndices(perturb_vector* pv, const precision* /*ppr*/,
                                                              int& index_pt,
...
void DNCDM_DecayRadiationSpecies::PerturbDerivs(double /*tau*/, const double* y, double* dy,
...
double DNCDM_DecayRadiationSpecies::Delta(const perturb_vector* pv, const double* y,
                                          const double* pvecback, const perturb_workspace* /*ppw*/) const {
  if (index_pt_F0_ < 0 || pvecback[index_bg_rho_] <= 0.) return 0.;
...
double DNCDM_DecayRadiationSpecies::Theta(const perturb_vector* pv, const double* y,
                                          const double* pvecback, const perturb_workspace* ppw) const {
  if (index_pt_F0_ < 0 || pvecback[index_bg_rho_] <= 0.) return 0.;
  double a = pvecback[bgm_->index_bg_a_];
  double a2 = a * a;
...
double DNCDM_DecayRadiationSpecies::DeltaP(const perturb_vector* pv, const double* y,
                                           const double* pvecback, const perturb_workspace* /*ppw*/) const {
  if (index_pt_F0_ < 0) return 0.;
  double a = pvecback[bgm_->index_bg_a_];
  double a2 = a * a;
  double rho_dr_over_f = (pba_->H0 / a2) * (pba_->H0 / a2);
...
double DNCDM_DecayRadiationSpecies::RhoPlusPShear(const perturb_vector* pv, const double* y,
                                                  const double* pvecback, const perturb_workspace* /*ppw*/) const {
  if (index_pt_F0_ < 0) return 0.;
  double a = pvecback[bgm_->index_bg_a_];
  double a2 = a * a;
