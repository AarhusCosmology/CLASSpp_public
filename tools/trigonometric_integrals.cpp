...
int cosine_integral(double x, double* Ci, ErrorMsg error_message) {
  ...
  if (fabs(x) <= 4.) {
    ...
    ci8 = em_const + log(x) +
          x2 *
              (-0.25e0 + x2 * (7.51851524438898291e-3 +
...
int sine_integral(double x, double* Si, ErrorMsg error_message) {
  ...
  if (fabs(x) <= 4.) {
    ...
    si8 = x *
          (1.e0 + x2 * (-4.54393409816329991e-2 +
