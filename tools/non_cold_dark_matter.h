...
public:
  ...
  std::tuple<double, double> GetRescaledParameters(int n_ncdm, double a, const double* lnf_array) const;
  ...
  std::vector<double> factor_ncdm_; /**< List of normalization factors for calculating energy density etc.*/
  ...
  std::vector<std::vector<double>> dlnf0_dlnq_ncdm_; /**< Vectors of logarithmic derivatives of p-s-d */
...
private:
  ...
  std::vector<int> ncdm_quadrature_strategy_; /**< Vector of integers according to quadrature strategy. */
